...
cp src-tauri/gen/android/app/build/outputs/apk/universal/release/app-universal-release-unsigned.apk \
  build/android-release/jingong-xiaozi-0.1.0-map-calibrated-v32-arm64-unsigned.apk

/Users/zzw4257/Library/Android/sdk/build-tools/36.0.0/zipalign -f -p 4 \
  build/android-release/jingong-xiaozi-0.1.0-map-calibrated-v32-arm64-unsigned.apk \
  build/android-release/jingong-xiaozi-0.1.0-map-calibrated-v32-arm64-aligned.apk
...
/Users/zzw4257/Library/Android/sdk/build-tools/36.0.0/apksigner sign \
  ...
  --out build/android-release/jingong-xiaozi-0.1.0-map-calibrated-v32-arm64-test-signed.apk \
  build/android-release/jingong-xiaozi-0.1.0-map-calibrated-v32-arm64-aligned.apk
```

本地 Android 烟测记录见 `qa/android-map-smoke-v32.md`。构建产物、截图和校准 JSON 默认不入库。
