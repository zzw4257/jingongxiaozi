...
exports.defaultStartRoomId = exports.palette = exports.viewOptions = exports.layerOptions = exports.quickTargets = exports.layerHints = exports.floorTitles = exports.floorOrder = void 0;
exports.compactRoomLabel = compactRoomLabel;
...
function compactRoomLabel(roomNo) {
    ...
    if (floorRoom)
        return `${floorRoom[1]}·${floorRoom[2]}F${floorRoom[3]}`;
    const numberedRoom = value.match(/^(\d{3})-(\d+)$/);
    if (numberedRoom)
        return value.length <= 6 ? value : `${numberedRoom[1]}-${numberedRoom[2]}`;
    return value;
}
